...
1. [`default.custom.yaml`](7-ibusrime/yaml/default.custom.yaml)
2. [`double_pinyin_flypy.custom.yaml`](7-ibusrime/yaml/double_pinyin_flypy.custom.yaml)

---

3. [`luna_pinyin.extended.dict.yaml`](7-ibusrime/yaml/luna_pinyin.extended.dict.yaml) 

---

4. [`luna_pinyin.anime.dict.yaml`](7-ibusrime/yaml/luna_pinyin.anime.dict.yaml)
5. [`luna_pinyin.basis.dict.yaml`](7-ibusrime/yaml/luna_pinyin.basis.dict.yaml)
6. [`luna_pinyin.chat.dict.yaml`](7-ibusrime/yaml/luna_pinyin.chat.dict.yaml)
7. [`luna_pinyin.computer.dict.yaml`](7-ibusrime/yaml/luna_pinyin.computer.dict.yaml)
8. [`luna_pinyin.daily.dict.yaml`](7-ibusrime/yaml/luna_pinyin.daily.dict.yaml)
9. [`luna_pinyin.hanyu.dict.yaml`](7-ibusrime/yaml/luna_pinyin.hanyu.dict.yaml)
10. [`luna_pinyin.idiom.dict.yaml`](7-ibusrime/yaml/luna_pinyin.idiom.dict.yaml)
11. [`luna_pinyin.name.dict.yaml`](7-ibusrime/yaml/luna_pinyin.name.dict.yaml)
12. [`luna_pinyin.net.dict.yaml`](7-ibusrime/yaml/luna_pinyin.net.dict.yaml)
13. [`luna_pinyin.selfdefined.dict.yaml`](7-ibusrime/yaml/luna_pinyin.selfdefined.dict.yaml)
14. [`luna_pinyin.sougou.dict.yaml`](7-ibusrime/yaml/luna_pinyin.sougou.dict.yaml)


Here's my file structure for reference: [File Structure](7-ibusrime/filestructure.txt)
